...
class Post extends DatabaseObject {
	...
	protected static $db_fields=array('id', 'filename', 'type', 'size', 'title', 'content', 'date');
	public $id;
	public $filename;
	public $type;
	public $size;
  ...
  public function attach_file($file) {
	...
	public function save() {
		...
		if(isset($this->id)) {
			// Really just to update the title
			$this->update();
		} else {
		  ...
		  if(!empty($this->errors)) { return false; }
			...
			// Make sure the title is not too long for the DB
